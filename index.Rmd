...
Textdaten in der empirischen Wissenschaft werden vor allem in der
qualitativen Forschung genutzt. Hier werden Texte "per Hand" nach Ihren
...
Sentiment von Textnachrichten falsch ausgelegt zu haben. Auch bei Anwendung der
ausgfeilteren Methoden quantitativer Textanalyse müssen wir uns dieser
...
graphischer Analyse mit dem **tidyverse**, einer populären Sammlung von R
packages.

Kapitel \@ref(BT19) befasst sich mit dem Inhalt und der Struktur des
Datensatzes, welcher im Kurs zur Textanalyse verwendet wird, den
Plenarprotokollen des 19. Deutschen Bundestags.
...
Wörter bevor wir uns der Arbeit mit Kombinationen mehrerer Wörter widmen.
Abgeschlossen wird der Block mit Techniken der Sentiment Analyse anhand eines
Dictionaries.
...
und uns damit auseinandersetzen, wie wir sie mit dem **tidyverse** integrieren
...
Der abschließende fünfte Block (Kapitel \@ref(ML1) & \@ref(ML2)) führt in die
...
englischsprachige Fachvokabular. Dies alles spräche dafür diese Einführung in
Englisch zu verfassen. Da aber das Datennmaterial, die Plenarprotokolle,
Deutsche Texte sind, blieb als Option nur der Kompromiss die Seite auf Deutsch
zu schreiben und die englischsprachigen Fachbegriffe einzubinden ohne sie zu
übersetzen.
