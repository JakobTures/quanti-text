...
Die aktuelleste Version von R für alle gängigen Betriebssysteme finden sich
...
für einige der populäreren Distribution bereit.
...
Kapitel \@ref(R2)), fürs Erste genügt es aber zu wissen, dass `print()` alles
...
Wir können data frames auch zuvor definierten Vektoren zusammensetzen.
...
zuvor geladene Funktion. Hier überschreibt das tidyverse package **dplyr**die
